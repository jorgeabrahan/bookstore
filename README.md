...
**Bookstore** a dynamic SPA website built in using React, Redux and an API to keep track of the books and categories. 
...
```
git clone https://github.com/jorgeabrahan/bookstore.git
```
...
To run the project, if you are on the bookstore folder path on your terminal you can execute the following command:
...
- **What is this project main purpose?**
  ...
  - To practice working with React and Redux.
